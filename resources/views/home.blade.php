					...
					<div class="row align-items-center justify-content-center">
						<div class="col-lg-6 text-center">
							...
							<div class="btn-wrapper mt-4">
								<a class="btn btn-warning btn-icon mb-sm-0 mt-3" href="https://www.creative-tim.com/product/argon-design-system">
	...
	<div class="section features-1">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="info">
						<div class="icon icon-lg icon-shape icon-shape-primary rounded-circle shadow">
						...
						<a class="text-primary" href="javascript:;">More about us
				...
				<div class="col-md-4">
					<div class="info">
						<div class="icon icon-lg icon-shape icon-shape-success rounded-circle shadow">
						...
						<a class="text-primary" href="javascript:;">Learn about our products
							<i class="ni ni-bold-right text-primary"></i>
						</a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="info">
						<div class="icon icon-lg icon-shape icon-shape-warning rounded-circle shadow">
						...
						<a class="text-primary" href="javascript:;">Check our documentation
							<i class="ni ni-bold-right text-primary"></i>
						</a>
					</div>
				</div>
