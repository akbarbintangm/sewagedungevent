<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-xl fixed-start my-3 ms-4 border-0 bg-white" id="sidenav-main">
	<div class="sidenav-header">
		...
		<a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
			...
			<span class="font-weight-bold ms-1">Argon Dashboard 2</span>
		</a>
	</div>
	...
	<div class="sidenav-footer mx-3">
		<div class="card card-plain shadow-none" id="sidenavCard">
			<img alt="sidebar_illustration" class="w-50 mx-auto" src="{{ asset('/img/illustrations/icon-documentation.svg') }}">
		...
		<a class="btn btn-dark btn-sm w-100 mb-3" href="https://www.creative-tim.com/learning-lab/bootstrap/license/argon-dashboard" target="_blank">Documentation</a>
		<a class="btn btn-primary btn-sm w-100 mb-0" href="https://www.creative-tim.com/product/argon-dashboard-pro?ref=sidebarfree" type="button">Upgrade to pro</a>
	</div>
</aside>
